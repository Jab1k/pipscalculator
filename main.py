...
def calculate_pips(entry_price, exit_price, pair):
    ...
    Args:
        ...
        pair (str): Currency pair (e.g., 'EURUSD', 'USDJPY', 'XAUUSD').
...
def main():
    try:
        ...
        exit = float(input(f"Chiqishzonasini kiriting (xozirda: {xauusd["Last Trade"]}): "))
        pair = input("Qaysi platformada ishlayapsiz ? (Misol uchun:EURUSD, USDJPY, XAUUSD): ").upper()
